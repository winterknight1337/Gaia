...
apollo_subparser.add_argument("-u", "--callback-url", required=True, type=str, metavar='', help="URL (excluding port) the C2 agents will connect to")
apollo_subparser.add_argument("-p", "--callback-port", required=True, type=int, metavar='', default=80, help="Port that C2 agents will connect to")
...
poseidon_subparser.add_argument("-u", "--callback-url", required=True, type=str, metavar='', help="URL (excluding port) the C2 agents will connect to")
poseidon_subparser.add_argument("-p", "--callback-port", required=True, type=int, default=80, metavar='80', help="Port that C2 agents will connect to")
...
athena_subparser.add_argument("-u", "--callback-url", required=True, type=str, metavar='', help="URL (excluding port) the C2 agents will connect to")
athena_subparser.add_argument("-p", "--callback-port", required=True, type=int, default=80, metavar='80', help="Port that C2 agents will connect to")
