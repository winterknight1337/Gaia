...
sudo $PWD/mythic-cli install github https://github.com/MythicC2Profiles/basic_webhook.git

echo "Installing Registry Browser!"
sudo $PWD/mythic-cli install github https://github.com/MythicC2Profiles/registry_browser.git

echo "Installing LDAP Browser!"
sudo $PWD/mythic-cli install github https://github.com/MythicC2Profiles/ldap_browser.git
